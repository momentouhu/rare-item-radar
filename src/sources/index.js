...
import { clabo } from './clabo.js';
import { hareruya2 } from './shopify.js';

/**
 * 公式APIがあるもの: rakuten_ichiba / rakuten_books / yahoo_shopping（Worker でも動く）
 * スクレイパ: surugaya / sevennet / tower / hobbysearch / clabo / hareruya2(Shopify汎用)（GitHub Actions でのみ動く。
...
export const SOURCES = Object.fromEntries(
  [rakuten_ichiba, rakuten_books, yahoo_shopping, surugaya, sevennet, tower, hobbysearch, clabo, hareruya2].map((s) => [s.id, s])
);
